...
export type NonSubscriptionPurchase = z.infer<typeof nonSubscriptionPurchaseSchema>;
...
export const customerInfoSchema = z.object({
  subscriber: z.object({
    ...
    non_subscriptions: z.record(z.string(), z.array(nonSubscriptionPurchaseSchema)).nullish(),
  }),
});
