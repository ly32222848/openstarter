...
import { PaymentStatus, SubscriptionStatus } from "../../../../server/status";

import type { NonSubscriptionPurchase, Subscription } from "../schema/customer-info";
...
export const toSubscriptionStatus = (subscription: Subscription): SubscriptionStatus => {
...
export const toPaymentStatus = (purchase: NonSubscriptionPurchase): PaymentStatus => {
